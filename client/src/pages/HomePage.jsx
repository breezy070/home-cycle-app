  ...
  return (
    <div className='container flex flex-col mx-auto overflow-hidden'>
      ...
      <div className='flex flex-row content-center justify-center gap-10 m-10'>
        <img src="images/bike11.jpg" alt="" className='object-cover size-full h-96'/>
        <img src="images/bike12.jpg" alt="" className='object-cover size-full h-96'/>
      </div>
      <div className='flex flex-col'>
        ...
        <div className='flex flex-col mx-auto gap-10 mb-10 '>
          <div className='flex flex-row gap-10'>
            <img src="images/bike14.jpg" alt="" className='object-cover size-42 max-w-sm'/>
          ...
          <div className='flex flex-row gap-10'>
            <img src="images/bike21.jpg" alt="" className='object-cover size-42 max-w-sm'/>
            <div className='flex flex-col justify-between max-w-sm'>
